...
import com.skythinker.gptassistant.MyInterface.AsrClientBase;
import com.skythinker.gptassistant.MyInterface.BaiduAsrClient;
import com.skythinker.gptassistant.BuildConfig;
import com.skythinker.gptassistant.MyInterface.ChatApiClient;
import com.skythinker.gptassistant.util.ChatManager;
import com.skythinker.gptassistant.util.ChatManager.ChatMessage.ChatRole;
import com.skythinker.gptassistant.util.ChatManager.ChatMessage;
import com.skythinker.gptassistant.util.ChatManager.MessageList;
import com.skythinker.gptassistant.util.ChatManager.Conversation;
import com.skythinker.gptassistant.util.ConfirmDialog;
import com.skythinker.gptassistant.util.GlobalUtils;
import com.skythinker.gptassistant.MyInterface.GoogleAsrClient;
import com.skythinker.gptassistant.MyInterface.HmsAsrClient;
import com.skythinker.gptassistant.util.MarkdownRenderer;
import com.skythinker.gptassistant.util.MyAccessbilityService;
...
//        markdownRenderer.render(tvGptReply, etUserInput.getText().toString());
    ...
    public boolean checkInput(String input){
        List<String> startAppKey = GlobalDataHolder.getStartAppKey();
        for (String keyName : startAppKey) {
